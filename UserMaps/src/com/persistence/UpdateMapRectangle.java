...
public class UpdateMapRectangle {
    ...
    public void storeMap(Map map) throws Exception {
        ...
        Connection connection = DriverManager.getConnection("jdbc:mysql://localhost:3306/DataCollection1", "root", "root");
        if (connection != null) {
    ...
    public void storeScientistRectangle(String suname, int rectId) throws Exception{
        ...
        String storeSciRect = "insert into ScientistRectangles values ( ?,?);";
